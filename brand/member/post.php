...
if($action=="postnew")
{
	...
	refreshto($FROMURL,"<A HREF='?job=edit&fid=$fid&id=$id'>返回修改</A> <A HREF='../bencandy.php?fid=$fid&id=$id' target='_blank'>查看效果</A>",600);
