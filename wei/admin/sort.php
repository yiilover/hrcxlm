...
{
	if(!table_field("{$_pre}sort",'metatitle')){
		$db->query("ALTER TABLE  `{$_pre}sort` ADD  `metatitle` VARCHAR( 255 ) NOT NULL AFTER  `maxperpage`");
	}
	//检查父栏目是否有问题
