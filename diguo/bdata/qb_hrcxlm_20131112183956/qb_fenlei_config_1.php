...
E_D("replace into `qb_fenlei_config` values('GroupPostInfo','2','');");
...
E_D("replace into `qb_fenlei_config` values('Info_allcityType','1','');");
E_D("replace into `qb_fenlei_config` values('Info_MemberChooseCity','1','');");
E_D("replace into `qb_fenlei_config` values('Info_sys','0','');");
E_D("replace into `qb_fenlei_config` values('Info_GuestPostPicNum','','');");
E_D("replace into `qb_fenlei_config` values('Info_ReportDB','垃圾信息\r\n虚假信息\r\n违法信息\r\n雷同信息','');");
E_D("replace into `qb_fenlei_config` values('module_id','36','');");
...
E_D("replace into `qb_fenlei_config` values('Info_ForbidGuesViewContact','1','');");
...
E_D("replace into `qb_fenlei_config` values('rand_num','1381922779','');");
E_D("replace into `qb_fenlei_config` values('rand_num_inputname','BHX','');");
E_D("replace into `qb_fenlei_config` values('Info_webadmin','','');");
E_D("replace into `qb_fenlei_config` values('Info_allowGuesSearch','0','');");
E_D("replace into `qb_fenlei_config` values('Info_contact','010-88888888\r\nkefu@gmail.com\r\nkefu@msn.com\r\n88888888','');");
E_D("replace into `qb_fenlei_config` values('Info_description','','');");
E_D("replace into `qb_fenlei_config` values('Info_metakeywords','','');");
...
E_D("replace into `qb_fenlei_config` values('if_GGmap','1','');");
...
E_D("replace into `qb_fenlei_config` values('SEO_description','','');");
E_D("replace into `qb_fenlei_config` values('SEO_keywords','','');");
E_D("replace into `qb_fenlei_config` values('SEO_title','','');");
E_D("replace into `qb_fenlei_config` values('Info_webname','分类信息','');");
E_D("replace into `qb_fenlei_config` values('IF_Private_tpl','0','');");
E_D("replace into `qb_fenlei_config` values('Private_tpl_head','','');");
E_D("replace into `qb_fenlei_config` values('Private_tpl_foot','','');");
...
E_D("replace into `qb_fenlei_config` values('Info_GroupPostYzImg','2,8,9','');");
E_D("replace into `qb_fenlei_config` values('Info_GroupCommentYzImg','2,8,9','');");
