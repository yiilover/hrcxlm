...
E_D("replace into `qb_fenlei_field` values('86','1','附注信息','content','mediumtext','0','1','ieedit','500','300','','','','','0','0','0','0','','','','','31');");
...
E_D("replace into `qb_fenlei_field` values('79','1','室内布局','my_rooms','varchar','30','8','radio','0','0','两室一厅\r\n两室两厅\r\n三室一厅\r\n三室两厅\r\n一室一厅\r\n一居室\r\n三室以上\r\n别墅','','','','0','1','1','0','','','','','31');");
...
E_D("replace into `qb_fenlei_field` values('138','15','地区','content','varchar','255','0','select','400','50','山东-威海','','','','0','0','0','0','','','','','31');");
E_D("replace into `qb_fenlei_field` values('139','15','额度','sortid','int','3','0','text','0','0','1|类别一\r\n2|类别二\r\n3|类别三','','','','0','0','1','1','','','','','31');");
E_D("replace into `qb_fenlei_field` values('140','15','用途','my_822','varchar','255','0','text','0','0','','','','','0','0','0','0','','','','','31');");
E_D("replace into `qb_fenlei_field` values('141','15','可提供担保','my_303','varchar','255','0','text','0','0','','','','','0','0','0','0','','','','','31');");
E_D("replace into `qb_fenlei_field` values('142','15','利率','my_460','varchar','255','0','text','0','0','','','','','0','0','0','0','','','','','31');");
E_D("replace into `qb_fenlei_field` values('143','15','要求','my_391','mediumtext','0','0','textarea','0','0','','','','','0','0','0','0','','','','','31');");
E_D("replace into `qb_fenlei_field` values('144','15','内容','my_404','mediumtext','0','0','ieedit','500','300','','','','','0','0','0','0','','','','','31');");
