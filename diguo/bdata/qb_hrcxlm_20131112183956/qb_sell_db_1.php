...
E_D("replace into `qb_sell_db` values('19','1','0','1');");
E_D("replace into `qb_sell_db` values('20','1','0','1');");
E_D("replace into `qb_sell_db` values('21','1','0','1');");
E_D("replace into `qb_sell_db` values('22','1','0','1');");
E_D("replace into `qb_sell_db` values('23','1','0','1');");
E_D("replace into `qb_sell_db` values('24','1','0','1');");
