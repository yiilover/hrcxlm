...
E_D("replace into `qb_jfabout` values('6','2','发表文章可得{\$webdb[postArticleMoney]}个积分','只有审核后的文章才可得积分,没审核的文章不得积分.','0');");
E_D("replace into `qb_jfabout` values('7','2','删除文章扣除{\$webdb[deleteArticleMoney]}个积分','','0');");
