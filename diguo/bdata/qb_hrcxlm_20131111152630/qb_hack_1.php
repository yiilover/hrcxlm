...
E_D("replace into `qb_hack` values('login','用户登录插件','0','','a:3:{s:10:\"systemType\";s:6:\"齐博CMS\";s:9:\"guestcode\";s:0:\"\";}','','','','index.php?lfj=hack&hack=login&job=list','','','','0','','0');");
...
E_D("replace into `qb_hack` values('baidu_sitemap','百度地图','0','','','','','','index.php?lfj=baidu_sitemap&job=make','','other','插件大全','1','','0');");
