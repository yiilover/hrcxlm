...
if($job=="config"&&$Apower[center_config])
{
	...
	$ForbidDoHy[intval($webdb[ForbidDoHy])]=' checked ';
	$ForbidUpHy[intval($webdb[ForbidUpHy])]=' checked ';
...
elseif($job=="user_reg"&&($Apower[user_reg]||$Apower[center_config]))
{
	...
	$webdb['RegQyGroupid'] || $webdb['RegQyGroupid']=8;
	$select_group=select_group("webdbs[RegQyGroupid]",$webdb['RegQyGroupid']);
	$RegQyNeedCheck[intval($webdb[RegQyNeedCheck])] = ' checked ';
	$RegQyNoNeedFull[intval($webdb[RegQyNoNeedFull])] = ' checked ';
	$RegQySendMail[intval($webdb[RegQySendMail])] = ' checked ';
	$RegQyYzSendMail[intval($webdb[RegQyYzSendMail])] = ' checked ';
