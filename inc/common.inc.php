...
unset($webdb,$Html_Type,$erp,$ltitle,$memberlevel,$showHtml_Type,$chdb,$fidDB,$rsdb,$ModuleDB,$city_DB,$Mdomain,$Murl,$choose_class,$foot_tpl,$head_tpl,$ch_file,$index_tpl,$seo_tile,$zone_DB,$street_DB);
...
if(count($city_DB[name])==1){	//单城市版,强制城市ID
	...
	$tempDomain = preg_replace("/http:\/\/([^\/]+)\/(.*)/is","http://\\1",$WEBURL);
