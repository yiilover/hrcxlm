...
if($m){
	$titleDB['title']=$titleDB['keywords']=$rsdb['title'].' 商家介绍';
...
$updateinfo=($lfjuid==$uid)?"<a href='$webdb[_www_url]/member/?main=$Murl/member/homepage_ctrl.php?&atn=info2' target='_blank'>修改公司介绍</a>":"<br/>";
print <<<EOT
-->
<div class="maincont1">
	<div class="head"><div class="tag">商家简介</div><div class="more">$updateinfo</div></div>
