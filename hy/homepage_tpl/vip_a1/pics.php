...
if($m){
	$titleDB['title']=$titleDB['keywords']=$titleDB['description']=$rsdb['title'].' 商家的图片介绍信息';
}
...
print <<<EOT
-->
	<a href='$webdb[_www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=pic_upload'  target='_blank'>上传图片</a> | <a href='$webdb[_www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=pic'  target='_blank'>管理</a> 
<!--
EOT;
}
print <<<EOT
