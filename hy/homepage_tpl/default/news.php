...
if($m){
	...
	$titleDB['title']=$titleDB['keywords']=$rsdb['title'].' 商家新闻列表';
	$titleDB['description']="这里是有关于".$rsdb['title'].' 商家新闻列表';
...
print <<<EOT
-->
	<a href='$webdb[_www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=news' target='_blank'>管理新闻</a> | <a href='$webdb[_www_url]/member/?main=$Murl/member/homepage_ctrl.php?atn=postnews' target='_blank'>发布新闻</a> 
<!--
EOT;
}
print <<<EOT
