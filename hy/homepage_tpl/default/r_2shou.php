...
-->
<div class="maincont1">
	<div class="head head1"><div class="tag">二手信息</div><div class="more"><a href="?m=2shou&uid=$uid">更多</a></div></div>
	<div class="cont">		
		<ul class="liscoupons">
<!--
EOT;
...
-->
			<li>
				...
				<div class="t">栏目：<a href="$webdb[www_url]/2shou/list.php?fid=$rs[fid]" target="_blank">$rs[fname]</a></div>
			</li>
<!--
EOT;
}print <<<EOT
