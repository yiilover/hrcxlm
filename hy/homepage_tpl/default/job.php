...
if($m){
	$titleDB['title']=$titleDB['keywords']=$titleDB['description']=$rsdb['title'].' 商家发布的职位招聘信息';
}
...
print <<<EOT
-->
	<a href='$webdb[_www_url]/member/?main=$webdb[_www_url]/hr/member/listjob.php?job=list' target='_blank'>管理招聘</a> | <a href='$webdb[_www_url]/member/?main=$webdb[_www_url]/hr/member/post_choose.php' target='_blank'>发布招聘</a> 
<!--
EOT;
}
print <<<EOT
