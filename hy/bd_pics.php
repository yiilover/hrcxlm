	...
	foreach($number AS $id){
		if($id!=''){
			if($type=='qq'){
				...
				$wwid = urlencode(WEB_LANG == 'utf-8' ? $id : gbk2utf8($id) );
				$return.="<a target='_blank' href='http://www.taobao.com/webww/ww.php?ver=3&touid=$wwid&siteid=cntaobao&status=1&charset=utf-8'><img border='0' src='http://amos.alicdn.com/realonline.aw?v=2&uid=$wwid&site=cntaobao&s=1&charset=utf-8' alt='点击这里给我发消息' /></a>";
