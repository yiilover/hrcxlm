...
\$postdb[content]='$postdb[content]';
	...
	if($ck++)
	{
		echo "请稍候，正在发送当中{$page}...<META HTTP-EQUIV=REFRESH CONTENT='0;URL=?lfj=$lfj&action=$action&page=$page&succeeNUM=$succeeNUM&failNUM=$failNUM'>";
		exit;
	}
	else
	{
