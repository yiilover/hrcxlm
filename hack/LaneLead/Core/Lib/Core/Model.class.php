...
class Model {
	...
	protected $serializeField = array();  // 序列化字段定义 修改:深蓝 QQ:570713592 WEB:www.lanelead.com
    // 是否自动检测数据表字段信息
    ...
    public function flush() {
		...
		//序列化字段合并,以便create时自动完成字段序列化 修改:深蓝 QQ:570713592 WEB:www.lanelead.com
		foreach ($this->serializeField as $key=>$val){
			$this->fields = array_merge($this->fields,$val);
		}
