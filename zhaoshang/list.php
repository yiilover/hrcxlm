...
//SEO
$titleDB[title]	= $fidDB[metatitle]?strip_tags($fidDB[metatitle]):strip_tags("{$city_DB[name][$city_id]} {$zone_DB[name][$zone_id]} {$street_DB[name][$street_id]} $fidDB[name] $seo_tile");
$titleDB[keywords] = strip_tags($fidDB[metakeywords]);
$titleDB[description] = strip_tags($fidDB[metadescription]);
