...
elseif($job=="config"&&ck_power('center_config'))
{
	...
	$postLouPanNeedQy[intval($webdb[postLouPanNeedQy])]=" checked ";
	$postHireHouseQy[intval($webdb[postHireHouseQy])]=" checked ";
	$postSellHouseNeedQy[intval($webdb[postSellHouseNeedQy])]=" checked ";
	...
	$group_view_contact=group_box("webdbs[group_view_contact]",explode(",",$webdb[group_view_contact]));
