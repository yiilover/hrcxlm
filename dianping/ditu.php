...
foreach($listdb AS $key=>$rs){
	...
	$pointMsgAarray[]="'商家名称：<A HREF=\"bencandy.php?fid=$rs[fid]&id=$rs[id]\" target=\"_blank\"><b>$rs[title]</b></A><br>联系电话：<b>$rs[mobphone]</b><br><A HREF=\"bencandy.php?fid=$rs[fid]&id=$rs[id]\" target=\"_blank\"><img onerror=\"this.src=\'$webdb[www_url]/images/default/nopic.jpg\'\" width=150 height=120 border=0 src=\"$rs[picurl]\"></A>'";
}
