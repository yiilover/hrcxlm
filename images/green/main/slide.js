...
function setfoc(id){
	...
	document.getElementById("a_jimg").title = ttlarry[id];
...
document.write("<div class='showpic'><a class='a_jimg' id='a_jimg' href='"+lnkarry[0]+"' title='"+ttlarry[0]+"' target='_blank'><img id='bigimg' style='filter:RevealTrans (duration='1',transition='23'); visibility:visible;' src='"+picarry[0]+"'><\/a><\/div>");
document.write("<div class='showlist'>");
for(var j=0;j<rl;j++){
	if(j==0){
		document.write("<div class='on' id='thedl0' onmouseover='setfoc(0)' onmouseout='playit()'><img src='"+picarry[j]+"' width='80' height='40'><\/div>");	
	}else{
		document.write("<div id='thedl"+j+"' onmouseover='setfoc("+j+")' onmouseout='playit()'><img src='"+picarry[j]+"' width='80' height='40'><\/div>");	
	}
}
document.write("<\/div>");
document.close();