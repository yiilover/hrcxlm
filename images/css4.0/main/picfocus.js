$(".atc_up span").mouseover(function(){
	$(this).addClass("ck");
});
$(".atc_up span").mouseout(function(){
	$(this).removeClass("ck");
});
$(".atc_down span").mouseover(function(){
	$(this).addClass("ck");
});
$(".atc_down span").mouseout(function(){
	$(this).removeClass("ck");
});
...
new ImagesSlider("ListCompany",{leftHandle:"upcompany",rightHandle:"downcompany"});
new ImagesSlider("ListCompanys",{leftHandle:"upcompanys",rightHandle:"downcompanys",duration:20,timeLapse:20});