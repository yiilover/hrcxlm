...
E_D("replace into `qb_template` values('25','专题模板一(头与底要白板)','11','template/special/showsp2.htm','','0');");
E_D("replace into `qb_template` values('26','专题模板二(头与底要白板)','11','template/special/special_sport.htm','','0');");
E_D("replace into `qb_template` values('27','专题模板三(头与底要白板)','11','template/special/special_car.htm','','0');");
E_D("replace into `qb_template` values('28','专题模板四(头与底要白板)','11','template/special/special_finance.htm','','0');");
E_D("replace into `qb_template` values('29','专题模板五(头与底要白板)','11','template/special/sp1.htm','','0');");
