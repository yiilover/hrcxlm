...
E_D("replace into `qb_2shou_config` values('Info_DelKeyword','暴乱\r\n反动','');");
...
E_D("replace into `qb_2shou_config` values('Info_closeWhy','网站维护当中,暂停开放','');");
...
E_D("replace into `qb_2shou_config` values('Info_ClosePostWhy','严打时期,暂停发布与修改信息','');");
...
E_D("replace into `qb_2shou_config` values('Info_YzKeyword','性爱\r\n做爱\r\n共产党','');");
...
E_D("replace into `qb_2shou_config` values('Info_areaname','全国','');");
...
E_D("replace into `qb_2shou_config` values('Info_description','提供最新的二手交易信息','');");
E_D("replace into `qb_2shou_config` values('Info_metakeywords','二手数码出售 二手电脑出售','');");
E_D("replace into `qb_2shou_config` values('module_pre','2shou_','');");
E_D("replace into `qb_2shou_config` values('module_close','0','');");
E_D("replace into `qb_2shou_config` values('SEO_description','','');");
E_D("replace into `qb_2shou_config` values('SEO_keywords','','');");
E_D("replace into `qb_2shou_config` values('SEO_title','','');");
E_D("replace into `qb_2shou_config` values('Info_webname','二手市场','');");
...
E_D("replace into `qb_2shou_config` values('Info_ReportDB','垃圾信息\r\n虚假信息\r\n违法信息\r\n雷同信息','');");
E_D("replace into `qb_2shou_config` values('rand_num_mktime','5','');");
