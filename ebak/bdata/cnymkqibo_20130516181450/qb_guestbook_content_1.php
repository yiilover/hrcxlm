...
E_D("replace into `qb_guestbook_content` values('13','0','1','','','','','1','admin','192.168.0.99','普通管理员成为超级管理员的方法是,修改文件/CMS/admin.php,把里边的帐号更换一下即可','1','1240206958','1240206958','','');");
E_D("replace into `qb_guestbook_content` values('14','0','1','','','','','1','admin','192.168.0.99','整站系统的数据库配置文件是/CMS/mysql_config.php','1','1240207079','1240207079','','');");
