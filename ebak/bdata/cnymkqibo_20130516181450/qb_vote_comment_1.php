...
E_D("replace into `qb_vote_comment` values('14','6','0','1','admin','1239025849','&nbsp;Ö¤&nbsp;Âë:','127.0.0.1','0','1');");
E_D("replace into `qb_vote_comment` values('22','6','0','1','admin','1283825218','fdsadf','127.0.0.1','0','1');");
E_D("replace into `qb_vote_comment` values('19','11','0','1','admin','1240210890','²»´íÑ½','192.168.0.99','0','1');");
E_D("replace into `qb_vote_comment` values('20','11','0','1','admin','1255082863','fdsa','127.0.0.1','0','1');");
E_D("replace into `qb_vote_comment` values('21','11','0','1','admin','1283823884','ll','127.0.0.1','0','1');");
