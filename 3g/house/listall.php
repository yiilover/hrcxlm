...
$query = $db->query("SELECT SQL_CALC_FOUND_ROWS * FROM {$_pre}content WHERE yz=1 AND mid != 6 $SQL ORDER BY $ordertype DESC LIMIT $min,$rows");
...
require(Mpath."template/list_house.htm");
