...
$query = $db->query("SELECT SQL_CALC_FOUND_ROWS * FROM {$_pre}content A WHERE A.yz=1 $SQL ORDER BY A.$ordertype DESC LIMIT $min,$rows");
...
require(Mpath."template/list_shop.htm");
